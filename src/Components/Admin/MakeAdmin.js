...
const MakeAdmin = () => {
  return (
    <div className="bg-white rounded-lg p-5 m-5">
      ...
      <div class="form-floating mb-10 w-full">
        <input
          type="email"
        ...
        />
        <label for="floatingFilter" class="text-gray-700">
          Enter email to filter
        </label>
      </div>

      <table class="table-fixed w-full divide-y divide-dashed">
